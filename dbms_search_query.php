...
<div class="dropdown"> 
 ...
 <h1 style="text-align: center; color:white; font-size: 200px;" >Database Management System</h1>
	...
	<?php include('dbms_open_query.php');?>
	</div>
...
<div class="c2">
<a href="dbms_query.php">Back to All Queries</a>
...
echo "<br>";
$r1="SELECT * FROM dbms_questions NATURAL JOIN dbms_answers WHERE question LIKE '%".$a."%'";
...
echo "<br>";
$r1="SELECT question,A.Qno as qno,Qsch_no,Qfac_id FROM dbms_questions as A WHERE question LIKE '%".$a."%' AND A.Qno not in (select Qno from dbms_answers)";
$result1=mysql_query($r1);
...
<div class="c1">
<form action="dbms_answer_query.php" method="post">
...
<input style="height:100px;width:400px;" type="submit" value="Submit"/>
	...
	<a href="http://iips.icci.edu.iq/images/exam/databases-ramaz.pdf">Fundamentals of Database Systems Elmasri & Navathe</a>
	<br><br>
	<a href="https://inspirit.net.in/books/database/Database%20System%20Concepts.pdf">Database System Concepts Silberschatz, Korth & Sudershan</a></div>
</body>
</html>	
