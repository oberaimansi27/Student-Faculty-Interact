...
<div class="c2">
<a href="student_query.php">Back to All Queries</a>
...
echo "<br>";
$r1="SELECT * FROM `open_questions` NATURAL JOIN `open_answers` WHERE `question` LIKE '%".$a."%'";
...
echo "<br>";
$r1="SELECT question,A.Qno as qno,Qsch_no,Qfac_id FROM open_questions as A WHERE question LIKE '%".$a."%' AND A.Qno not in (select Qno from open_answers)";
$result1=mysql_query($r1);
