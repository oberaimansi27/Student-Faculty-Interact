...
<div class="queries">
<div class="c2">
<?php include('ada_QandA.php');?></div></div>
...
<input style="height:100px;width:400px;" type="submit" value="Submit"/>
	...
	<br><br>
	<a href="http://ressources.unisciel.fr/algoprog/s00aaroot/aa00module1/res/%5BCormen-AL2011%5DIntroduction_To_Algorithms-A3.pdf">Introduction to Algorithms Cormen and Rivest</a>
	</div>
</body>
</html>	
