...
<div class="dropdown"> 
 ...
 <h1 style="text-align: center; color:white; font-size: 200px;" >Probability and Queuing Theory</h1>
 
	
	<div class="askqueries">
	<?php include('pqt_open_query.php');?>
	</div>
	...
	<div class="Search">
<form action="pqt_search_query.php" method="post">
...
<div class="c2">
<a href="pqt_query.php">Back to All Queries</a>
...
echo "<br>";
$r1="SELECT * FROM pqt_questions NATURAL JOIN pqt_answers WHERE question LIKE '%".$a."%'";
...
echo "<br>";
$r1="SELECT question,A.Qno as qno,Qsch_no,Qfac_id FROM pqt_questions as A WHERE question LIKE '%".$a."%' AND A.Qno not in (select Qno from pqt_answers)";
$result1=mysql_query($r1);
...
<div class="c1">
<form action="pqt_answer_query.php" method="post">
...
<a href="pqt1.pdf">Fundamentals of Probabilty and Statistics for Engineers by TT Soong</a><br><br>
	<a href="pqt2.pdf">Probabilty and Statistics for Engineers and Scientists</a>
